...
- A ACLP single sign-on enabled subscription
...
### Configuring ACLP for single sign-on
...
* [How to integrate ACLP with Azure Active Directory](https://docs.microsoft.com/azure/active-directory/saas-apps/aclp-tutorial)
