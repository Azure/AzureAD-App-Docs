...
- A AuditBoard single sign-on enabled subscription
...
### Configuring AuditBoard for single sign-on
...
* [How to integrate AuditBoard with Azure Active Directory](https://docs.microsoft.com/azure/active-directory/saas-apps/auditboard-tutorial)
