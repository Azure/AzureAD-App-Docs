...
- A Benchling single sign-on enabled subscription
...
### Configuring Benchling for single sign-on
...
* [How to integrate Benchling with Azure Active Directory](https://docs.microsoft.com/azure/active-directory/saas-apps/benchling-tutorial)
