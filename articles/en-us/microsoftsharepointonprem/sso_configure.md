...
2. **Configure a new trusted identity provider in SharePoint Server 2016**
	...
	$wsfedurl="<**Azure AD Single Sign-On Service URL** : %metadata:singleSignOnServiceUrl% value which you have copied from the Azure portal>"
...
* [How to integrate SharePoint on-Premises with Azure Active Directory](https://docs.microsoft.com/azure/active-directory/active-directory-saas-sharepointon-premises-tutorial)
